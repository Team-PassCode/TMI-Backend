...
const VerifyEndTime = (value: any, helpers: any) => {
  ...
  if (value < startTime) return helpers.error("any.invalid");
  return value;
};
...
export { ValidateCreateAppoiment, ValidateUpdateAppoiment };
